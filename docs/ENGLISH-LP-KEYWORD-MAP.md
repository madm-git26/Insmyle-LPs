...
They now have a dedicated **"Where most of our patients come from"** section directly above
the footer:
...
location section, so both pages remain at 100% coverage. The emergency page is now 9 sections and
...
minutes after everywhere else has shut."* Location phrases live in the location-section
