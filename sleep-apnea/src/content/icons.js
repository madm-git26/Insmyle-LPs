/**
 * Icon path data — shared by the React <Icon> component and the static
 * standalone build, so the two can never drift. Raw SVG markup strings on a
 * 24px grid, 1.5px strokes, rounded caps.
 */
